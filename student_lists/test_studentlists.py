...
class TestStudentLists(TestCase):
    ...
    def teset_can_create_class_with_postive_number_of_students(self):
        test_class = ClassList(1)


    def test_add_student_check_student_in_list(self):
        test_class = ClassList(2) # this creates a new class with space for 2 new students (max)
        test_class.add_student('Test Student') # This will add the student
        self.assertIn('Test Student', test_class.class_list)

        test_class.add_student('Another Test Student') # This will add another student
        self.assertIn('Test Student', test_class.class_list)
        self.assertIn('Another Test Student', test_class.class_list)



    def test_add_student_already_in_list(self): # Adding another test
        test_class = ClassList(2)
        test_class.add_student('Test Student') # Adding a new student
        with self.assertRaises(StudentError):
            test_class.add_student('Test Student') # This will add the student
    ...
    def test_add_remove_student_ensure_removed(self):
        test_class = ClassList(2)
        test_class.add_student('Test Student') # creating an object
        test_class.remove_student('Test Student') # this is an action
    ...
    # add a b and c, try to remove d and assert if you get a student error
    ...
    def test_is_enrolled_when_student_present(self):
        ...
        self.assertTrue(test_class.is_enrolled('Martha Stewart')) # for this to pass - this has to be true
    ...
    # add example students, call the is_enrolled method and verify that they are correctly enrolled.
    # check the two methods above
    ...
    # I can run in top right but not in terminal?